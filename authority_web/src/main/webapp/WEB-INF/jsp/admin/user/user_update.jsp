...
<div class="body_main">
	<form class="layui-form layui-form-pane"  enctype="multipart/form-data" >
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" name="userName" autocomplete="off"
					   placeholder="请输入用户名" class="layui-input" onblur="checkUserName()"  value="${user.userName}">
			</div>
		</div>
		<div class="layui-form-item">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="tel" name="tel"  autocomplete="off"  value="${user.tel}"
		...
		<div class="layui-upload">
			...
			<img
			<%--						todo 修改图片地址--%>
					src="https://cut192623.oss-cn-beijing.aliyuncs.com/${user.userImg}" class="layui-nav-img">

						...
						<li class="layui-nav-item layui-nav-itemed"><a class="" href="javascript:;"><span class='iconfont icon-setup'></span>&nbsp;&nbsp;系统管理</a>
							<shiro:hasPermission name="user:list">
								<dl class="layui-nav-child">
									<dd>
										<a href="javascript:;" style="padding-left: 40px;" data-url="${pageContext.request.contextPath}/user/toListPage">
							...
							<shiro:hasPermission name="role:list">
								<dl class="layui-nav-child">
									<dd>
										<a href="javascript:;" style="padding-left: 40px;" data-url="${pageContext.request.contextPath}/role/toListPage">
							...
							<shiro:hasPermission name="menu:list">
								<dl class="layui-nav-child">
									<dd>
										<a href="javascript:;" style="padding-left: 40px;" data-url="${pageContext.request.contextPath}/menu/toListPage">

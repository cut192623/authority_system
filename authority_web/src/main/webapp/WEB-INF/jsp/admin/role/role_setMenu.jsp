...
<body>
	<div style="padding: 15px;">
		<input id="id"  value="${role_id}" type="hidden">
		<table class="layui-hide" id="menu" lay-data="{id: 'menu'}"></table>
		<div>
			<button id="sub" class="layui-btn bt_setMenu">立即提交</button>
		...
		$(function () {
			layui.use('table', function() {
				...
				$('#sub').on('click',function (){
					var checkStatus = layui.table.checkStatus($('table').attr("id")).data;
					var roleId = $("#id").val();
					console.log(checkStatus)
					$.ajax({
						url:"${ctx}/menu/roleSetMenu?roleId="+roleId,
						method:"post",
